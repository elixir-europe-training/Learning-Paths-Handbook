...
- Think about the expected background (overall level of expertise, educational background, or professional experience you expect the audience to have when engaging with the LPearning Path).
...
- Be specific about characteristics such as skill level and domain knowledge.
...
## Use-case example
**Bioinformatics for Genomics Learning Path:** The target audience comprises postgraduate students (master’s or PhD level) who have introductory programming skills and foundational knowledge of molecular biology.
